---
title: Git日常使用
description: Git的日常使用。文章的内容包括了 Git 的常用命令，以及介绍了分支管理策略，这包含了 master 主分支和开发分支 develop 以及 临时分支等。文章最后涵盖了配置 ss 登录以及多人协作的内容。
categories:
 - Git
tags:
 - Git
...
![001](https://yangmingxian.com/assets/imgs/2017/001.png)
...
+ 主分支Master
    ...
    ![002](https://yangmingxian.com/assets/imgs/2017/002.png)
...
+ 开发分支Develop
    ...
    ![003](https://yangmingxian.com/assets/imgs/2017/003.png)
...
+ 临时性分支
    ...
    + 功能（feature）分支
        ...
        ![004](https://yangmingxian.com/assets/imgs/2017/004.png)

    + 预发布（release）分支

    + 修补bug（fixbug）分支

        ![005](https://yangmingxian.com/assets/imgs/2017/005.png)
